...
const MainSectionTwo = () => (
  <Section img={shipping} mobile={shippingMobile}>
    <ClipPath white>
      <Heading blue>Sprowadzamy</Heading>

      <Description blue>
        ZAŁATWIAMY FORMALNOŚCI W USA ORAZ ORGANIZUJEMY WYSYŁKĘ DO POLSKI.
        ZAJMUJEMY SIĘ WSZYSTKIMI DOKUMENTAMI ZWIĄZANYMI Z CŁEM, AKCYZĄ I VATEM.
      </Description>
    </ClipPath>
  </Section>
);
